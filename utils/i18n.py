...
STATIC_TRANSLATIONS = {
    "en": {
        ...
        "Afficher la carte en plein écran": "Show map fullscreen",
        "Actualiser la carte": "Refresh map",
        "Actualiser les positions des véhicules": "Refresh vehicle positions",
        "Priority: ": "Priority: ",
    ...
    "fr": {
        ...
        "Quitter le plein écran": "Quitter le plein écran",
        "Afficher la carte en plein écran": "Afficher la carte en plein écran",
        "Actualiser la carte": "Actualiser la carte",
        "Actualiser les positions des véhicules": "Actualiser les positions des véhicules",
        "Priority: ": "Priorité : ",
